...
function gm() {
    ...
    console.log("done"), Y.useEffect(() => {
        e === 100 && R(!0), e === 10 && C(!0), e === 11 ? f(40) : e > 11 && f(h => h - 1)
    }, [e]), Y.useEffect(() => {
    ...
    const Be = () => {
        ...
        Xe = (h, A) => {
            if (ht.event({
                ...
                F.right < T.right + T.width * .2 && F.left > T.left - T.width * .2 && F.top > T.top - T.height * .2 && F.bottom < T.bottom + T.height * .2 && (t(e + 1), s(!0))
            }
            r(!1), l({
                x: 0,
                y: 0
